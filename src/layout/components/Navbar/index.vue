  ...
  <div class="navbar">
    ...
    <div :key="restKey"
      ...
      <div class="rightStatus">
        ...
        <div v-if="storeId > 100">
          <button v-if="status===1" @click="handleStatus"
                class="businessBtn">营业中</button>
          <button v-else @click="handleStatus"
                class="businessBtn closing">打烊中</button>
